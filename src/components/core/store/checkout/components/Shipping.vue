    ...
    <template v-if="enableFilter">
      <div class="flex items-center gap-4">
        <div class="flex items-center gap-2">
          <input id="express" v-model="selectedFilter" type="radio" name="shipping-speed" value="express" />
          <label for="express">Express Delivery</label>
        </div>
        <div class="flex items-center gap-2">
          <input id="standard" v-model="selectedFilter" type="radio" name="shipping-speed" value="standard" />
          <label for="standard">Standard</label>
        </div>
        <div class="flex items-center gap-2">
          <input id="pick-up" v-model="selectedFilter" type="radio" name="shipping-speed" value="pick-up" />
