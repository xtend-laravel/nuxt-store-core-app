  ...
  <div>
    <div class="mb-4 flex flex-col md:flex-row items-start md:items-center justify-between">
      <div class="flex items-center gap-6 font-medium">
        <button type="button" class="flex gap-1 items-center text-brand-500">
          <IconCheck class="w-4 h-4" />
          <span>Shipping address</span>
        </button>
        <button type="button" class="flex gap-2 items-center text-gray-300">
          <IconCheck class="w-4 h-4" />
          <span>Billing address</span>
        </button>
      </div>
      <a href="#" class="uppercase font-semibold !underline">
        Create new address
      </a>
    </div>
